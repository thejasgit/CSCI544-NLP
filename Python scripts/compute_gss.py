...
def findValue(state,cinema,sports):
    ...
    #     os.makedirs(results)
    print len(sportsNews)
    details['state'] = len(stateNews)
    details['cinema'] = len(cinemaNews)
    details['sports'] = len(sportsNews)
...
def gss(setAllWords , cinemaWordDict ,lenCinema,stateWordDict ,lenState,sportsWordsDict,lenSports) :
    ...
    p1Dict = {}
    progress2 = open('gssprogress.txt', 'w')
    progress2.write('50')
    progress2.close()
...
state = "Crawler/corpuscrawler/udayavani_state_news.json"
cinema = "Crawler/corpuscrawler/udayavani_cinema_news.json"
sports = "Crawler/corpuscrawler/udayavani_sports_news.json"
progress2 = open('gssprogress.txt', 'w')
progress2.write('0')
progress2.close()
